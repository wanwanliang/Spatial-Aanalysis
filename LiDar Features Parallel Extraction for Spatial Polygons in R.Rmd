...
## R has a very neat package called lidR that can process Lidar data efficiently. In this post, I use lidR to extract Lidar features for spatial polygons with parallels.
...
#### Using 10 cores on a computer with 16gb memory, the processing time for 500 polygons took 11 mins in R console (in Rmarkdown it took 15mins as R Code tends to run slower in Markdown ). Not bad I would say.
